...
sudo sh -c "echo /home/ec2-user/instantclient_19_6 > \
   		/etc/ld.so.conf.d/oracle-instantclient.conf"
sudo ldconfig

# Set file and folder permissions / ownership
chown -R ec2-user:ec2-user /home/ec2-user/instantclient_19_6
...
Connection="/home/ec2-user/instantclient_19_6/sqlplus '$DBUser/$DBPassword@(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=$Endpoint)(PORT=$Port))(CONNECT_DATA=(SID=$DBName)))' @maximo_oracle_database_objects.sql"

# Write command to shell script file
Executable="/home/ec2-user/create_objects.sh"
echo "#!/bin/bash" > $Executable
echo "LD_LIBRARY_PATH=/home/ec2-user/instantclient_19_6:$LD_LIBRARY_PATH" >> $Executable
echo "export LD_LIBRARY_PATH" >> $Executable
echo "PATH=$PATH:/home/ec2-user/instantclient_19_6" >> $Executable
